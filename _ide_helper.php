...
')
     ...
     */ 
        ...
        {
                        return \App\Services\ZohoService::generateToken();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getAllRecords($token, $moduleName)
        {
                        return \App\Services\ZohoService::getAllRecords($token, $moduleName);
        }
...
namespace  { 
            ...
            class Zoho extends \App\Facades\ZohoFacade {}
